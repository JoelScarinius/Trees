...
{   
    // int firstArr[SIZE] = {27,36,37,39,41,45,63,72};
    // int secondArr[SIZE] = {27,36,37,39,41,45,63,72};
...
int main()
{
    ...
    while (1)
    {
        ...
        {   
            ...
            else { HUR GÖR JAG FÖR ATT SKRIVA ÖVER DET FÖRSTA TRÄDET???
